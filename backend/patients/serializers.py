    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            if user:
                ...
                file_log(f"[SERIALIZER] Novo usuário salvo para {email}, email será enviado após commit")
        ...
        if should_send_email and email_user_id:
            try:
                ...
                dispatch_task(send_welcome_email_task, email_user_id, email_nutritionist_name)
