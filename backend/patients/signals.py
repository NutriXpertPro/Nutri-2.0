...
def create_patient_notification(sender, instance, created, **kwargs):
    ...
    if created:
        try:
            ...
            # Enviar email de boas-vindas agora é controlado pelo Serializer para evitar duplicidade
            # e garantir que ocorra apenas quando desejado (novos cadastros/reativações manuais).
            pass
        except Exception:
