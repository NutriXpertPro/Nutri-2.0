...
from . import views
from .views_diary import (
    PatientDiaryEntryViewSet,
...
from .views_patient_data import (
    ...
    patient_notes_view,
    PatientDietsViewSet,
    PatientEvaluationsViewSet,
    PatientLabExamsViewSet,
)
...
diary_router.register(
    r"diary-entries", PatientDiaryEntryViewSet, basename="patient-diary-entry"
)
...
patient_data_router.register(
    r"metrics", PatientMetricsViewSet, basename="patient-metrics"
)
patient_data_router.register(r"meals", PatientMealsViewSet, basename="patient-meals")
patient_data_router.register(
    r"evolution", PatientEvolutionViewSet, basename="patient-evolution"
)
patient_data_router.register(
    r"measurements", PatientMeasurementsViewSet, basename="patient-measurements"
)
patient_data_router.register(
    r"photos", ProgressPhotoViewSet, basename="progress-photos"
)
patient_data_router.register(r"exams", PatientExamsViewSet, basename="patient-exams")
patient_data_router.register(
    r"appointments", PatientAppointmentsViewSet, basename="patient-appointments"
)
patient_data_router.register(r"notes", ClinicalNoteViewSet, basename="clinical-notes")
patient_data_router.register(r"diets", PatientDietsViewSet, basename="patient-diets")
patient_data_router.register(
    r"evaluations", PatientEvaluationsViewSet, basename="patient-evaluations"
)
patient_data_router.register(
    r"lab_exams", PatientLabExamsViewSet, basename="patient-lab-exams"
)
...
urlpatterns = [
    ...
    path(
        "<int:pk>/resend-password-link/",
        views.resend_password_reset_link,
        name="resend_password_link",
    ),
