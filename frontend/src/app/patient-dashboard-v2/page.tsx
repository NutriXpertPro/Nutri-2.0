...
function DashboardContent() {
    ...
    return (
        <div className="relative min-h-screen bg-background text-foreground pb-40 font-sans selection:bg-emerald-500/30 flex flex-col items-center">
            ...
            <div className="w-full max-w-md mx-auto bg-emerald-500/5 h-1 border-b border-emerald-500/10 z-20 sticky top-16" />

            <main className="relative z-10 flex-1 pt-4 px-4 space-y-6 w-full max-w-md mx-auto">
