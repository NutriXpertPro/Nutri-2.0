...
import { Search, Plus, Filter, Download, Edit, Utensils, Info, ChevronDown, Check } from 'lucide-react'
...
export default function FoodManagementContent() {
    ...
    const sources = [
        ...
        },
        {
            id: 'TBCA',
            label: 'TBCA',
            activeClass: 'bg-orange-500 text-white border-orange-600 shadow-md shadow-orange-500/20',
            inactiveClass: 'bg-transparent text-orange-600 dark:text-orange-400 border-orange-500/30 hover:bg-orange-500/5 hover:border-orange-500/50'
        },
        {
            id: 'USDA',
            label: 'USDA',
        ...
        <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center bg-card p-4 rounded-xl border shadow-sm sticky top-0 z-20">
                ...
                <Button
                    ...
                    className="h-8 px-3 rounded-lg font-normal gap-1 bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm border-0"
                >
