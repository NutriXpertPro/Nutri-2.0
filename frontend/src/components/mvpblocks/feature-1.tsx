...
const features = [
  ...
  },
  {
    ...
    desc: 'Um painel inteligente que mostra quem está engajado e quem precisa de atenção. Visualize exames laboratoriais, métricas corporais e a taxa de adesão em tempo real. Tenha o controle absoluto de cada detalhe da jornada do seu paciente.',
  },
  {
  ...
  },
  {
    ...
    title: 'Suplementos Personalizados com 500+ Opções',
    desc: 'Biblioteca exclusiva com mais de 500 suplementos únicos para prescrições personalizadas baseadas no perfil metabólico e objetivos individuais de cada paciente.',
  },
];
