...
function InfoItem({ icon: Icon, label, value, sub, className, iconColor }: InfoItemProps) {
    return (
...
function Section({ icon: Icon, color, title, content, type, emptyText }: SectionProps) {
